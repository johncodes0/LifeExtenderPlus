...
public class HomeTab extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((LinearLayout)activityLayout).addView(mCallApiButton);
        ...
        ((LinearLayout)activityLayout).addView(mOutputText);
...
//                }
        ...
        private boolean overlaps(Event a, Event b){
            ...
            long startMin = b.getStart().getDateTime().getValue()/ (1000 * 60) % 60;
